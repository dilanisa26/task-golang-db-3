...
func main() {
	...
	// Tambahkan middleware CORS dengan konfigurasi khusus
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:5173"}, // Izinkan origin dari aplikasi Vue Anda
		AllowMethods:     []string{"GET", "POST", "PATCH", "DELETE", "OPTIONS"},
		AllowHeaders:     []string{"Content-Type", "Authorization"}, // Tambahkan "Authorization" ke headers yang diizinkan
